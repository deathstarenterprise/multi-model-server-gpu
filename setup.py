...
if __name__ == '__main__':
    ...
    setup(
        ...
        version=version,
        description='(Altered for multiprocessing GPU Inference) Multi Model Server is a tool for serving neural net models for inference',
        author='Trinity team + Blake Donahoo',
        author_email='noreply@amazon.com, blake@duke.ai',
        long_description=pypi_description(),
        url='https://github.com/deathstarenterprise/multi-model-server-gpu',
